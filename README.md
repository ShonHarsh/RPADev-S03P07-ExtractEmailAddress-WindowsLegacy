...
This project is my solution in **Windows Legacy (Deprecated), C#** to the **Extract Email Address** practice found in section 03 practice 07 of the UiPath - RPA Developer Foundation course.
...
**GitHub:** https://github.com/ShonHarsh/RPADev-S03P07-ExtractEmailAddress-WindowsLegacy
...
```sh
git clone https://github.com/ShonHarsh/RPADev-S03P07-ExtractEmailAddress-WindowsLegacy
```
